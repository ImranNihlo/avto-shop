          ...
          <div className='row justify-content-center'>
            <div className='col-8'>
              <form>
                ...
                <button type="submit" className="btn btn-primary w-100 radius-2v blue mt-2 fw-bold height">LOGIN</button>
              </form>
                  ...
                  <div className='row justify-content-between m-0'>
                    <div className='col-1 border rounded-circle back-red p-0 text-center'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                           className="bi bi-google pb-1" viewBox="0 0 16 16">
                        <path
                ...
                <div className='col-8 text-start text-start-top'>
                  <div className='row justify-content-between m-0'>
                    <div className='col-1 border rounded-circle back-blue p-0 text-center'>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                           className="bi bi-facebook pb-1 text-start-top" viewBox="0 0 16 16">
                        <path
