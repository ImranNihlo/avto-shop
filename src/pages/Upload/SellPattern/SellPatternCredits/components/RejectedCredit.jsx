...
function RejectedCredit (props) {
  return (
    <div className="row p-0 border-top pt-2 pb-2">
      ...
      <div className="col-2 text-center align-self-center text-decoration-underline text-danger cursor">
        Rejected
      </div>
    </div>
  )
