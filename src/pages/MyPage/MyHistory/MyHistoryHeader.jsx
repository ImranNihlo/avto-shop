...
function MyProjectHeader (props) {
  return (
    <div className="col-8 row justify-content-between p-0">
      ...
      <div className="col-8 row justify-content-between align-self-center p-0">
        <div className="col align-self-center">
          Period inquiry
        </div>
        <div className="col-3">
          <div className="row justify-content-between bg-light rounded">
            <input type="date" name="calendar" className="border-0 col-7"/>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                 className="bi bi-calendar-date text-black mb-1 col-5" viewBox="0 0 16 16">
              <path
